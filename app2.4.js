"use strict";
let X = 1; // Any type can be declare here
X = 'I\'m Mohammad Arkan';
X = true;
let Y = 1; // When you don't know the type you can use unknown as type;
...
const result = Y + ' Is it working?'; // Another way to use it but not that much good
function testAny(input) {
    console.log(`User input is: ${input}`);
}
testAny('You should work hard');
testAny(17);
function testUnknown(input) {
